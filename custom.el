(custom-set-variables
 ...
 '(package-selected-packages
   '(cider clj-refactor cobol-mode consult corfu crux diff-hl diminish
           eat editorconfig eglot ellama fish-mode flymake-guile
           flymake-kondor geiser-guile go-mode graphviz-dot-mode
           htmlize jinx julia-repl julia-snail lua-mode magit
           marginalia markdown-mode meson-mode modus-themes olivetti
           orderless paredit pkg-info plantuml-mode rainbow-delimiters
           rg smartparens tempel tramp typescript-mode undo-tree
           use-package vertico which-key yasnippet))
